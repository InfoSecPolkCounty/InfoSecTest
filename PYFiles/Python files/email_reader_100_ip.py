...
ip_list = []
countries = {"AF": "Afghanistan", "AX": "Aland Islands", "AL": "Albania", "DZ": "Algeria", "AS": "American Samoa",
             ...
             "LT": "Lithuania", "LU": "Luxembourg", "MO": "Macao", "MK": "Macedonia, Republic of", "MG": "Madagascar",
...
attacks = ["Remote Code Execution", "Command Injection", "Mozi", "Config File Download Attempt", "Lokibot",
           "XML External Entity Attack", "Malicious Scan Request", "ThinkPHP getShell Remote Code Execution",
           "Directory Information Leak", "Data Execution Protection", "Gpon Router Cmd Injection",
           "Remote OS Command Injection"]
file_path = 'C:/Data/ThreatData.txt'
file = open(file_path, 'w')



def parse_mail(ip_list):
    global messages
